...
class ApiService {
  ...
  static Future<void> deleteAspiration(String token, String aspirationId) async {
    if (AppConfig.useMockMode) {
      await Future.delayed(const Duration(milliseconds: 500));
      _mockAspirations.removeWhere((a) => a.id == aspirationId);
      _mockComments.removeWhere((c) => c.aspirationId == aspirationId);
    } else {
      try {
        ...
        throw Exception('Gagal menghapus aspirasi di Supabase: $e');
      }
    }
  }
